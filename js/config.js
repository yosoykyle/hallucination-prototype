...
const PROVIDERS = {
  ...
  openrouter: { name: 'OpenRouter', defaultBaseUrl: 'https://openrouter.ai/api', format: 'openai', models: ['meta-llama/llama-3.3-70b-instruct:free', 'meta-llama/llama-3.2-3b-instruct:free', 'liquid/lfm-2.5-1.2b-instruct:free', 'google/gemma-4-31b-it:free', 'openai/gpt-oss-20b:free'], hint: 'Free models at openrouter.ai — no credit card needed' },
